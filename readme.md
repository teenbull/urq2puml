...
- 🎨 **Разноцветно!** - локации раскрашены по смыслу: концовки зеленым 🟢, дубликаты и фантом красным 🔴, циклы (метки со ссылками сами на себя) - желтым 🟡; пунктирные стрелки - неявные переходы `⋯>` (авто-переходы, возврат *proc*, фантомные ссылки, меню), синие стрелки - кнопки с пустыми надписями ➡️, кнопки-меню (%) помечены иконкой курсора 🖱️, локальные кнопки (!) помечены иконкой закладки 🔖 и выглядят более серыми.
