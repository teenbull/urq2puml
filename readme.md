...
- 🎨 **Разноцветно!** - локации раскрашены по смыслу: концовки зеленым 🟢, дубликаты, локации-сиротки и фантом красным 🔴, циклы (метки со ссылками сами на себя) - желтым 🟡; пунктирные стрелки - неявные переходы `⋯>` (авто-переходы, возврат *proc*, меню), кнопки-меню (%) помечены иконкой курсора, локальные кнопки (!) помечены иконкой закладки и выглядят не так ярко.
